...
import { Sparkles, Edit2, MapPin, RefreshCw, Send } from 'lucide-react';
    ...
    <div className="flex-col pb-6">
      ...
      <div style={{ backgroundColor: 'white', padding: '1.25rem', borderRadius: '16px', marginBottom: '1.5rem', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
        ...
        <div>
          ...
          <div style={{ backgroundColor: '#F3F4F6', padding: '0.75rem 1rem', borderRadius: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: '0.9rem', fontWeight: '500', color: '#1F2937' }}>Pavement / Sidewalk Damage</span>
      ...
      <div style={{ backgroundColor: '#EFFFF4', padding: '1.25rem', borderRadius: '16px', marginBottom: '1.5rem' }}>
        <div className="flex-row items-center justify-between mb-4">
          <div className="flex-row items-center gap-3">
            ...
            <div>
              ...
              <div style={{ fontSize: '0.8rem', color: '#047857' }}>40.7128° N, 74.0060° W</div>
            </div>
          </div>
        ...
        <div style={{ backgroundColor: '#F8FCF9', border: '1px solid #e1f5e8', padding: '0.75rem 1rem', borderRadius: '12px' }}>
          <div style={{ fontSize: '0.85rem', fontWeight: '600', color: '#1F2937' }}>221B Baker Street, NW1 6XE</div>
          <div style={{ fontSize: '0.7rem', color: '#6B7280' }}>Westminster, Greater London</div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div style={{ backgroundColor: '#E5E7EB', padding: '1rem', borderRadius: '16px', fontSize: '0.9rem', color: '#374151', lineHeight: '1.5' }}>
          The sidewalk has significant cracking and a deep pothole that creates a tripping hazard for elderly residents and school children frequently using this path.
        </div>
      </div>

      {/* Submit Button */}
      <button className="btn-primary" style={{ backgroundColor: '#7C8FF0' }}>
        <Send size={18} />
        Submit Report
      </button>
    </div>
