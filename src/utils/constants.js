...
const STATUS_NORMALIZATION_MAP = {
  ...
  [ISSUE_STATUS.REPORTED]: ISSUE_STATUS.REPORTED,
  [ISSUE_STATUS.ASSIGNED]: ISSUE_STATUS.ASSIGNED,
  ...
  [ISSUE_STATUS.REJECTED]: ISSUE_STATUS.REJECTED,
  [ISSUE_STATUS.COMPLETED]: ISSUE_STATUS.COMPLETED,
  [ISSUE_STATUS.VERIFIED]: ISSUE_STATUS.VERIFIED,
};

export const PENDING_ISSUE_STATUSES = [ISSUE_STATUS.PENDING, ISSUE_STATUS.OPEN, ISSUE_STATUS.REPORTED];
